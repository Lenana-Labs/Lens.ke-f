  ...
  return (
    <footer className="w-full bg-[color:var(--color-footer-bg)] rounded-t-[24px] mt-8 pt-12 pb-4 flex flex-col text-white">
      ...
      <div className="max-w-7xl mx-auto px-6 w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
        ...
        {/* Column 3: Licensing */}
        <div>
          <h3 className="text-white font-semibold mb-6 tracking-wide uppercase text-sm">Licensing</h3>
          <ul className="space-y-4 text-sm">
            <li><Link href="#" className="text-gray-400 hover:text-white transition-colors">Editorial License</Link></li>
            <li><Link href="#" className="text-gray-400 hover:text-white transition-colors">Commercial License</Link></li>
            <li><Link href="#" className="text-gray-400 hover:text-white transition-colors">License FAQ</Link></li>
          </ul>
        </div>
